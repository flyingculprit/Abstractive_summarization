...
word_blueprint = Blueprint('word', __name__, template_folder="templates")

# Configure upload folder
UPLOAD_FOLDER = "word_uploads"
...
@word_blueprint.route("/", methods=["GET", "POST"])
def upload_file():
    original_text = None
    summary_text = None
...
@word_blueprint.route("/download/<filename>")
